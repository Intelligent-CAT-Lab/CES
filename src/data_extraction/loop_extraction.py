...
def run_all_py(root):
    ...
    write_dir = f"/home/changshu/CodeMind/dataset/Loops/{dataset_name}_.json"
    for d in os.listdir(root):
        # if d!='HumanEval_107':
        #     continue
        if 'CodeNet' in root:
            code_path = os.path.join(root, d, 'main', 'main.py')
        elif 'single_line_all_1_Python' in root:
            code_path = f"/home/changshu/LLM_REASONING/prompts/single_line_all_1_Python/{d}/main/main.py"            
        ...
        if len(data['For']) > 0 or len(data['While']) > 0:
            ...
            if dataset_name == 'single_line_all_1_Python':
